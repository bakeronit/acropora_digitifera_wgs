...
inshore_manhattan_data <- make_manhattan_ihs("inshore") %>% add_column(pop="Inshore")
northoffshore_manhattan_data <- make_manhattan_ihs("northoffshore") %>% add_column(pop="North Offshore")
southoffshore_manhattan_data <- make_manhattan_ihs("southoffshore") %>% add_column(pop="South Offshore")

ggplot(rbind(inshore_manhattan_data,northoffshore_manhattan_data,southoffshore_manhattan_data)) +
