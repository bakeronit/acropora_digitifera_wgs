...
rucetree <- treeio::drop.tip(rucetree,"FI-1-3")
rucetree <- treeio::drop.tip(rucetree,"MI-1-4")
...
uce_st <- data.frame(tiplab=rucetree@phylo$tip.label) %>% 
  mutate(newlab = case_when(
    ...
    grepl("^adi_R", tiplab) ~ "Acropora digitifera : SO",
    grepl("^adi_AR", tiplab) ~ "Acropora digitifera : NO",    
    grepl("^adi_AI", tiplab) ~ "Acropora digitifera : IN",    
    grepl("^adi_BR", tiplab) ~ "Acropora digitifera : IN",    
