...
recombination with background haplotypes. These suggest that our choice
of the representative SNP (ie a proxy for the locus of the beneficial
allele) might not be correct. Just based on the alleles at this proxy
locus starTMRCA will not be able to distinguish between the selected
haplotypes and other haplotypes in inshore.
...
`startmrca` analysis, and after writing it to disk we run the MCMC.
...
<img src="figures/sweep_dates_wide.png" width="1012" />
