...
ggplot(pop_pca_wa ,aes(x=e1,y=e2)) + 
...
For the pcadapt statistic we create a Manhattan plot to view sites under selection across the genome.
...
lengths <- read_tsv("data/hpc/pcangsd/all.lengths.txt",col_names = c("scaffold","length"))
