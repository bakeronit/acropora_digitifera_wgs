...
inshore_8hap <- read.table("data/hpc/demography/msmc_1/inshore_8hap.final.txt", header=TRUE) %>% add_column(pop="inshore")
noffshore_8hap <-read.table("data/hpc/demography/msmc_1/noffshore_8hap.final.txt", header=TRUE) %>% add_column(pop="northoffshore")
soffshore_8hap <-read.table("data/hpc/demography/msmc_1/soffshore_8hap.final.txt", header=TRUE) %>% add_column(pop="soffshore")
