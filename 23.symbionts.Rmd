...
Firstly, reads were extracted from duplicates marked bam files and mapped to *Cladocopium* (C1) genome. The symbiont mitogenome sequence was downloaded from [reefgenomics](http://symbs.reefgenomics.org/download/).
...
**Figure: The haplotype network of symbiont Cladocopium C1 mitochondiral in 41 coral samples**
