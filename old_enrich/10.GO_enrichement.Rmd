...
require(topGO)
require(ggsci)
gene_table <- readRDS("cache/cadidate_genes.rds")
source("scripts/R/load_uniprot_annot.R")
```

Genes located in the candidate regions were extracted. We identified 425, 372, and 355 in inshore, north offshore, and south offshore population respectively.
```{r eval = FALSE}
gene_table <- readRDS("cache/cadidate_genes.rds")
