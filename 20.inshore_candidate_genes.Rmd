...
We extract top 1% outlier in iHS, XP-EHH, and XP-nSL and made a statistic of all haplotype-based selection scan using `multiIntersectBed`. In the interected bed file, it displays the all regions that were identified as significantly under selection in as least one method and the occurrences of them.
