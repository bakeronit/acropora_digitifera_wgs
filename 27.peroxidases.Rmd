...
This produced a total of 105 sequences (including Acropora digitifera proteins) that we aligned using the MAFFT plugin in Geneious.  We then masked positions with less than 50% aligned bases to produce a final alignment with length 679. 
...
```{r}
library(ggtree)
tf <- read.tree("data/hpc/peroxidases/px_align.fasta.contree")
